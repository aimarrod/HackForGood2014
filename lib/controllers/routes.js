...
exports.create = function (req, res, next) {
  var descripton=req.body.properties.descripton;
  var name=req.body.properties.name;
  var publicRoute=req.body.properties.public;
  var locs=[];
  for(var i=0;i<geoJsonExample.features.length;i++){
    locs.push(req.features[i].geometry.coordinates);
  }
  var newRouteData={descripton: descripton, name: name, publicRoute: publicRoute, owner: req.user, assigned_routes:[], route: req.body, locs: locs};
